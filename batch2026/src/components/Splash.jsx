        ...
        >
          ...
          <div className="relative z-10 text-center px-6">
            ...
            <motion.h1
              ...
              className="font-display text-[clamp(3.5rem,12vw,8rem)] font-light text-accent-yellow leading-none text-glow mb-4"
            >
              Batch of 2026
            </motion.h1>
            ...
            <motion.p
              ...
              className="font-display text-xl md:text-2xl italic text-text-primary/40 mb-14 leading-relaxed"
            >
            ...
            >
              ...
              <span className="font-mono text-[8px] tracking-[0.4em] text-muted/30 uppercase">
