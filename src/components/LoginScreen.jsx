...
export default function LoginScreen({ onLogin, adminPreviewUser, onExitPreview }) {
  ...
  if (step === 'DONE') {
    return (
      <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0, scale: 1.05 }} transition={{ duration: 0.8 }} className="fixed inset-0 z-[99998] flex items-center justify-center bg-[#111111] px-4">
